					...
					<div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						{this.props.user ? (
							<ul className="nav navbar-nav navbar-right">
								<li className='profile-link'><Link to='/'>{this.props.user.first_name + ' ' + this.props.user.last_name}</Link></li>
								<li className='logout-link'><a onClick={this.logout} >Logout</a></li>
							</ul>
						) : (
							<ul className="nav navbar-nav navbar-right">
